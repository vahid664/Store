                                                ...
                                                @if(session('off')->type_off == 1)
                                                    <del>
                                                         <span class="price-product price-discount-color">
                                                            {{ number_format(session('basket_price')+$last_price) }}
                                                        </span>
                                                    </del>
                                                    <br>
                                                    <span class="checkout-summary-price-value-amount">
                                                        {{ number_format($last_price +(session('basket_price')- session('off')->price)) }}
                                                     </span>تومان
                                                @else
                                                    <del>
                                                         <span class="price-product price-discount-color">
                                                    ...
                                                    <br>
                                                    <span class="checkout-summary-price-value-amount">
                                                        {{ number_format($last_price +(session('basket_price')- (session('basket_price')*(session('off')->price_percent/100)))) }}
                                                     </span>تومان
                                                @endif
                                            @else
                                                {{ number_format($last_price + session('basket_price')) }}
                                            @endif

                                    </div>
                                    @if(Auth::user()->address_first != null)
                                        <a href="{{ url('buy/paymant') }}" class="selenium-next-step-shipping">
