            ...
            <div class="row">
                <div class="profile-page bg-white col-xl-9 col-lg-8 col-md-12 order-2 mt-2">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link py-1 px-3" id="home-tab"
                        ...
                        <li class="nav-item">
                            <a class="nav-link active py-1 px-3" id="profile-tab"
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active p-2" id="profile" role="tabpanel"
                             aria-labelledby="profile-tab">
                            @foreach($query->where('status',1)->where('delivery',1) as $value)
