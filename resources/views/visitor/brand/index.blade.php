...
@section('img-seo')
    ...
    @if(isset($brand->pic))
        <meta property="og:image" content="{{ asset($brand->pic) }}"/>
        <link rel="image_src" href="{{ asset($brand->pic) }}">
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="{{ asset($brand->pic) }}"/>
        <meta property="og:image:alt" content="{{ $brand->pic_alt != '' ? $brand->pic_alt : $brand->title }}"/>
    @endif
@endsection
                ...
                <aside class="sidebar-page col-12 col-sm-12 col-md-4 col-lg-3 order-1">
                    <div class="box">
                        <div class="box-content text-center">
                            <img class="lazy" data-src="{{ asset($brand->pic) }}" alt="{{ $brand->pic_alt }}" title="{{ $brand->pic_alt }}">

                            <h1 class="size-h1 font-weight-bold">{{ $brand->title }}</h1>
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="box-content d-none d-lg-block">
                            <div class="collapse show" id="collapseExample1">
                                <ul class="filter-option">
                                    @foreach(\App\Brand::all() as $value)
                                        <li class="py-1">
                                            <a href="{{ url('brand/'.Illuminate\Support\Str::slug($value->title_en)) }}" class="d-flex align-items-center justify-content-start">
                        ...
                        <div class="box-content d-block d-sm-none">
                    ...
                    <div class="breadcrumb-section default">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb-list" vocab="https://schema.org/" typeof="BreadcrumbList">
                                ...
                                <li class="breadcrumb-item" property="itemListElement" typeof="ListItem">
                                    <a property="item" typeof="WebPage" title="{{ $brand->title }}"
                                       href="{{ url('brand/'.Illuminate\Support\Str::slug($brand->title_en)) }}">
                                        <span property="name">{{ $brand->title }}</span>
                                    </a>
                        ...
                        <div class="tab-content py-3">
                            <div class="parent-expert default">
                                <div class="content-expert size-show">
                                    {!! \App\Helper\Helper::last_text_article(\App\Helper\Helper::Nofollow($brand->text)) !!}
                                </div>
