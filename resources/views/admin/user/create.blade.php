                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('Brand.store') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="title" type="text" placeholder="مثال : راکت" title="مقدار دهی الزامی"
                                               minlength="3" maxlength="70" pattern=".{3,70}"
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="keywords" type="text" placeholder="مثال : راکت"
                                               minlength="3" maxlength="70" pattern=".{3,70}"
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="description" type="text" placeholder="مثال : راکت"
                                               minlength="3" maxlength="191" pattern=".{3,191}"
