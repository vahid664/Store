            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" enctype="multipart/form-data" action="{{ route('ProductAwesome.update',$query->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="date_end" type="text" placeholder="مثال : خرید"
                                               ...
                                               value="{{ $query->date_end != '' ? \Carbon\Carbon::parse($query->date_end)->format('Y/m/d') : '' }}" autocomplete="off">
                                        @error('date_end')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="hour_start" type="number"
                                               ...
                                               name="hour_start"
                                               value="{{ $query->hour_start }}" required>
                                        @error('hour_start')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
