    ...
    <div class="container-fluid mb-5">
        <div class="row justify-content-center">
            <div class="col-md-5 col-12">
                <div class="card">
                    <div class="card-header bg-primary">مدیریت سایز ها
                    </div>
                    <div class="card-body">
                        <div id="jstree2">
                            <ul>
                                <li><a onclick="cat(0)">سردسته ها</a></li>
                                @foreach(\App\Size::where('parent',0)->with('child')->orderBy('sort')->get() as $value)
                                    <li>
                        ...
                        <div class="col-12 text-info mt-5">
                            حتما یکی از سایز ها باید انتخاب شود، با کلیک، سایز مورد نظر انتخاب می گردد.
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-7 col-12">
                <div class="card">
                    <div class="card-header  bg-success">لیست سایز های دسته انتخابی
                        <a href="{{ url('/Admin') }}" class="pull-left text-white">بازگشت
                            <i class="fa fa-arrow-left"></i>
                        </a>

                        @can(\App\Helper\Helper::getTypePermission('create'))
                        <a href="{{ url('Admin/Size/create') }}" class="pull-left btn btn-primary margin-top-n-4 text-white ml-4 px-3 mt-0 pt-1 pb-0">
                            <i class="fa fa-plus"></i>
                            افزودن
                        </a>
                        @endcan
                        <button id="sorting" data-url="{{ route('SortFree') }}" onclick="sorting('sizes');"
