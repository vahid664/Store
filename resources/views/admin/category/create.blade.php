                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="type" name="type">
                                            <option {{ old('type') == 2 ? 'selected' : '' }} value="2">فعال</option>
                                            <option {{ old('type') == 1 ? 'selected' : '' }} value="1">غیرفعال</option>
                                        </select>
                                        @error('type')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="menu" name="menu">
                                            <option {{ old('menu') == 1 ? 'selected' : '' }} value="1">فعال</option>
                                            <option {{ old('menu') == 0 ? 'selected' : '' }} value="0">غیرفعال</option>
                                        </select>
                                        @error('menu')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="form-control @error('short_text') is-invalid @enderror"
                                                  ...
                                                  placeholder="اختیاری">{{ old('short_text') }}</textarea>
                                        @error('short_text')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
