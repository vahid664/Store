            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-success">{{ $title }}
                        <a href="{{ url('Admin/Color') }}" class="pull-left text-white">
                            برگشت
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('Color.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="title_factory" class="col-md-3 col-form-label">
                                        <i class="fa fa-star text-danger"></i>
                                        عنوان کارخانه
                                    </label>

                                    <div class="col-md-9">
                                        <input id="title_factory" type="text" placeholder="مثال : st01"
                                               title="مقدار دهی الزامی"
                                               class="form-control @error('title') is-invalid @enderror"
                                               name="title_factory" value="{{ old('title_factory') }}" required>
                            ...
                            <div class="col-12  table-responsive">
                                <div class="col-md-12 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="jstree2">
                                            <ul>
                                                @foreach(\App\Color::where('parent',0)->with('child')->get() as $value)
                                                    <li>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ url('Admin/Color') }}" class="btn btn-outline-primary w-100">
                                                انصراف
                                            </a>
                                        </div>
                                    </div>
