            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" enctype="multipart/form-data" action="{{ route('Brand.update',$query->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="text-info">
                                            تصویر جدید، جایگزین تصویر قبلی خواهد شد.
                                        </div>
                                        @error('pic')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="color" type="color" required
                                               class="form-control @error('color') is-invalid @enderror" name="color" value="{{ $query->color }}">
                                        @error('color')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
