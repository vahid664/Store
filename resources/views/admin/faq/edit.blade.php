            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-success">{{ $title }}
                        <a href="{{ url('Admin/Faq/'.$query->faqable_id.'?model='.Arr::last(explode('\\',$query->faqable_type))) }}" class="pull-left text-white">
                            برگشت
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" enctype="multipart/form-data" action="{{ route('Faq.update',$query->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="question" type="text" placeholder="مثال : راکت"
                                               ...
                                               name="question" value="{{ $query->question }}" required>
                                        @error('question')
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="form-control @error('answer') is-invalid @enderror"
                                                  ...
                                                  placeholder="اختیاری">{{ $query->answer }}</textarea>
                                        @error('answer')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ url('Admin/Faq/'.$query->faqable_id.'?model='.Arr::last(explode('\\',$query->faqable_type))) }}" class="btn btn-outline-primary w-100">
                                                انصراف
                                            </a>
                                        </div>
                                    </div>
