            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" enctype="multipart/form-data" action="{{ route('Redirect.update',$query->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="before" type="text" title="مقدار دهی الزامی"
                                               ...
                                               name="before" value="{{ $query->before }}" required>
                                        @error('before')
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="after" type="text" title="مقدار دهی الزامی"
                                               ...
                                               name="after" value="{{ $query->after }}" required>
                                        @error('after')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="type" name="type">
                                            <option {{ $query->type == 1 ? 'selected' : '' }} value="1">ریدایرکت 301</option>
                                            <option {{ $query->type == 2 ? 'selected' : '' }} value="2">کنونیکال</option>
                                        </select>
                                        @error('type')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
